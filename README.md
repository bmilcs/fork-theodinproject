...
This repo contains the TOP app which pulls in lesson content as well as its front-end and back-end code. To view the actual lesson content that gets pulled in, please visit the [TOP curriculum repo](https://github.com/TheOdinProject/curriculum).
